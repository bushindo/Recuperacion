...
if ($_POST) {
    ...
    if ($dni==""){
        echo "No ha introducido ningun DNI."."<br/>";
         ...
         echo "DNI: " .$dni. " ";
         $numero = $dni;
    echo '  La letra del DNI "'.$numero.'" es "'.letra_nif($numero).'"<br/>';
     }
...
<TR>
   ...
   <TD> <INPUT TYPE="text" value='$nombre' SIZE=18 MAXLENGTH=18 name="nombre"> 
       F.Nac.:<INPUT TYPE="text" value='$fechana'  SIZE=10 MAXLENGTH=10 name="fechana"> 
...
<TR>
   ...
   <TD> <INPUT TYPE="text" value='$direccion'  SIZE=48 MAXLENGTH=48 name="direccion"></TD>

<TR>
  <TD>Codigo Postal:</TD>
  <TD> <INPUT TYPE="text" value='$CP' SIZE=5 MAXLENGTH=5 name="CP">
...
<TR>
   ...
   <TD> <INPUT TYPE="text" value='$provincia' SIZE=20 MAXLENGTH=20 name="provincia">
       Telefono: <INPUT TYPE="text" value='$telefono' SIZE=9 MAXLENGTH=9 name="telefono"></TD>
